// Copied from https://github.com/UltrusBot/ExtraSponges/blob/master/src/main/java/io/github/ultrusbot/extrasponges/block/HotLavaSpongeBlock.java

package net.hellzone.blocks;

import net.fabricmc.api.EnvType;
import net.fabricmc.api.Environment;
import net.hellzone.HellzoneTweaksMod;
...
public class HotMagmaSpongeBlock extends Block {
    ...
    // public static final IntProperty CHARGES = IntProperty.of("charges", 0, 64);
